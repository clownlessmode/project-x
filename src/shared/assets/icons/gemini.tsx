export const GeminiIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({
  className,
  ...props
}) => {
  return (
      ...
      <g mask="url(#mask0_10859_4894)">
        <g filter="url(#filter0_f_10859_4894)">
          <ellipse
            ...
            rx="14.2084"
            ry="16.7164"
            transform="matrix(0.942343 0.334649 -0.334656 0.94234 -7.979 13.7735)"
            fill="#FFE432"
          />
        </g>
        <g filter="url(#filter1_f_10859_4894)">
          <ellipse
            cx="27.0543"
            cy="2.55114"
            rx="18.3944"
        ...
        <g filter="url(#filter2_f_10859_4894)">
          <ellipse
            cx="19.2245"
            cy="24.9042"
            rx="19.2245"
            ry="24.9042"
            transform="matrix(0.998807 -0.0488254 0.0488266 0.998807 -1.72778 32.6573)"
            fill="#00B95C"
          />
        </g>
        <g filter="url(#filter3_f_10859_4894)">
          <ellipse
            cx="19.2245"
            cy="24.9042"
            rx="19.2245"
        ...
        <g filter="url(#filter4_f_10859_4894)">
          <ellipse
            cx="18.8429"
            cy="20.7441"
            rx="18.8429"
            ry="20.7441"
            transform="matrix(0.854301 -0.519779 0.51979 0.854294 -7.13574 47.5078)"
            fill="#00B95C"
          />
        </g>
        <g filter="url(#filter5_f_10859_4894)">
          <ellipse
            cx="66.4617"
            cy="24.977"
            rx="18.0933"
        ...
        <g filter="url(#filter6_f_10859_4894)">
          <ellipse
            cx="20.9292"
            cy="22.0752"
            rx="20.9292"
            ry="22.0752"
            transform="matrix(0.79599 0.60531 -0.60532 0.795982 -2.81885 -7.43323)"
            fill="#FBBC04"
          />
        </g>
        <g filter="url(#filter7_f_10859_4894)">
          <ellipse
            cx="24.1311"
            cy="22.2919"
            rx="24.1311"
            ry="22.2919"
            transform="matrix(0.824037 0.566536 -0.566546 0.82403 39.6338 0.310608)"
            fill="#3186FF"
          />
        </g>
        <g filter="url(#filter8_f_10859_4894)">
          <path
            d="M54.2255 -2.30403C57.0195 1.49462 53.4294 8.8804 46.2068 14.1926C38.9842 19.5048 30.8642 20.7318 28.0702 16.9331C25.2762 13.1345 28.8663 5.74867 36.0889 0.436486C43.3115 -4.8757 51.4315 -6.10267 54.2255 -2.30403Z"
            fill="#749BFF"
          />
        </g>
        <g filter="url(#filter9_f_10859_4894)">
          <ellipse
            cx="27.5853"
            cy="17.1478"
            rx="27.5853"
            ry="17.1478"
            transform="matrix(0.733166 -0.680049 0.680061 0.733155 -12.2583 9.49695)"
            fill="#FC413D"
          />
        </g>
        <g filter="url(#filter10_f_10859_4894)">
          <ellipse
            cx="14.7819"
            cy="8.59637"
            rx="14.7819"
            ry="8.59637"
            transform="matrix(0.813186 0.582004 -0.582016 0.813177 6.37842 30.511)"
            fill="#FFEE48"
          />
        </g>
      </g>
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            ...
            result="effect1_foregroundBlur_10859_4894"
          />
        </filter>
        <filter
          id="filter1_f_10859_4894"
          x="-15.1223"
          y="-40.0296"
          width="84.3533"
          height="85.1615"
